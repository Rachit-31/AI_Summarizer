...
dataset_billsum=load_dataset("lighteval/legal_summarization", "BillSum")
dataset_billsum

# summarising the dialog to check the working
# it will pirnt the summary that is written in the dataset
print("\nDialogue:")
print(dataset_billsum["test"][1]["dialogue"])

print("\nSummary")
print(dataset_billsum["test"][1]["summary"])

"""Evaluating the peagsus on samsum"""

dialogue=dataset_billsum['test'][0]['dialogue']
dialogue
